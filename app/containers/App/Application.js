...
import {
  ...
  Bank, PaymentMethod, Package, Category
} from '../pageListAsync';
    ...
    return (
      <Dashboard history={history} changeMode={changeMode}>
        <Switch>
          ...
          <Route path="/app/pages/bank" component={Bank} />
          <Route path="/app/pages/paymentMethod" component={PaymentMethod} />
          <Route path="/app/pages/package" component={Package} />
          <Route path="/app/pages/category" component={Category} />
