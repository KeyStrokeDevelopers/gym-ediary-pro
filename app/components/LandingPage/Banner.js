    ...
    return (
      ...
      >
        ...
        <div className={!slideMode ? classes.container : ''}>
          <Typography component="h2" variant="h2" gutterBottom>GYM-e-DIARY-Pro</Typography>
          <Typography component="p" variant="h5" gutterBottom>A online member management software</Typography>
